      ...
      evidenceRegions: [
        {
          ...
          description: 'High density urban settlement and commercial blocks.',
          badgeColor: 'amber',
        },
        {
          id: 'ev-02',
          ...
          description: 'Reinforced concrete arterial bridge structure spanning the river.',
          badgeColor: 'cyan',
        },
        {
          id: 'ev-03',
          ...
          bbox: [28, 60, 9.5, 12.5],
          confidence: 0.91,
          areaEstimate: '22,000 m²',
          description: 'Southern industrial logistics campus and manufacturing units.',
          badgeColor: 'emerald',
        },
        {
          id: 'ev-04',
          ...
          bbox: [57, 33, 7.5, 11.5],
          confidence: 0.89,
          areaEstimate: '9,800 m²',
          description: 'Secondary commercial block adjacent to arterial road.',
          badgeColor: 'amber',
        }
      ],
      landCoverBreakdown: [
